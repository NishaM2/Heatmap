...
// Better Auth rejects anything shorter, so check before the request goes out.
    ...
    <div className="relative min-h-screen bg-white p-3 font-sans text-neutral-900 antialiased">
      ...
      <div className="w-full max-w-sm rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
        <div className="mb-5 space-y-1">
          ...
          <p className="text-xs text-neutral-500">Start building better habits today.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-[11px] text-neutral-400">Must be at least 8 characters</p>
          </div>
